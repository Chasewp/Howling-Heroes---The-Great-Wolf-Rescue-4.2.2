...
class_name Wolf_Data_List_Singletons
extends Node
...
#Conservation Status
func _get_Eastern_Wolf_Conservation_status():
...
#Reset Wolves Rescue Data
func reset_Wolf_Rescue_data():
	Data_Wolves["Alaskan Tundra Wolf"]["Rescued"] = false
	Data_Wolves["Alexander Archipelago Wolf"]["Rescued"] = false
	Data_Wolves["Arabian Wolf"]["Rescued"] = false
	Data_Wolves["Arctic Wolf"]["Rescued"] = false 
	Data_Wolves["Baffin Island Wolf"]["Rescued"] = false
	Data_Wolves["British Columbian Wolf"]["Rescued"] = false
	Data_Wolves["Eastern Wolf"]["Rescued"] = false
	Data_Wolves["Eurasian Wolf"]["Rescued"] = false
	Data_Wolves["Gray Wolf"]["Rescued"] = false
	Data_Wolves["Great Plains Wolf"]["Rescued"] = false
	Data_Wolves["Greenland Wolf"]["Rescued"] = false
	Data_Wolves["Himalayan Wolf"]["Rescued"] = false
	Data_Wolves["Hudson Bay Wolf"]["Rescued"] = false
	Data_Wolves["Iberian Wolf"]["Rescued"] = false
	Data_Wolves["Indian Wolf"]["Rescued"] = false
	Data_Wolves["Interior Alaskan Wolf (Yukon Wolf)"]["Rescued"] = false
	Data_Wolves["Italian Wolf"]["Rescued"] = false
	...
	Data_Wolves["Steppe Wolf (Caspian Sea Wolf)"]["Rescued"] = false
	Data_Wolves["Tundra Wolf"]["Rescued"] = false
	Data_Wolves["Vancouver Coastal Island Wolf"]["Rescued"] = false
	var reset_Rescue_Wolves_Data = FileAccess.open(WOLVES_LIST_DATA,FileAccess.WRITE)
	reset_Rescue_Wolves_Data.store_line(JSON.stringify(Data_Wolves))
	reset_Rescue_Wolves_Data.close()
#######################################################################
